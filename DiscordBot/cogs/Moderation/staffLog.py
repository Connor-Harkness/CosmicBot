...
GUILD_ID = 501064326132793345
LOG_CHANNEL = 680847352977686562
...
class Stafflog(commands.Cog):
    ...
    async def reason(self, ctx, case_id: int, *, reason):
        ...
        msg = await self.bot.get_channel(LOG_CHANNEL).fetch_message(m_id)
        ...
        await msg.edit(embed=discord.Embed.from_dict(em))
